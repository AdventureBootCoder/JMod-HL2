...
hook.Add("EntityEmitSound", "JMOD_HL2_MUTEFDSound", function( t )
    local ent = t.Entity
    if ent:IsPlayer() and t.OriginalSoundName == "Player.FallDamage" and JMod.PlyHasArmorEff(ent, "fallProtect") then
        t.SoundName = "physics/metal/metal_box_impact_hard"..tostring(math.random(1, 3))..".wav"
		return true
    end
end)
